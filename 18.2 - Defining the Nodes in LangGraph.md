...
Uper function mein do nodes banaye hue hain jo same state jo use kar rahe hain. Jab hum node function mein state class as a argument use kar rahe hain to vo class simply messages naam ki list mein har node ki state ko append kar rahi hai.
